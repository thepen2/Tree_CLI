...
extern unsigned char const C_boilerplate_logo_bitmap[32];
#ifdef HAVE_BAGL
        #include "bagl.h"
...
extern unsigned char const C_icon_warning_bitmap[25];
        ...
        #endif // HAVE_BAGL
#ifndef GLYPH_old_logo_BPP
        #define GLYPH_old_logo_WIDTH 16
        #define GLYPH_old_logo_HEIGHT 16
        #define GLYPH_old_logo_BPP 1
extern unsigned int const C_old_logo_colors[];
extern unsigned char const C_old_logo_bitmap[32];
#ifdef HAVE_BAGL
        #include "bagl.h"
        extern const bagl_icon_details_t C_old_logo;
        #endif // GLYPH_old_logo_BPP
        #endif // HAVE_BAGL
