...
unsigned char const C_boilerplate_logo_bitmap[] = {
  0xff, 0xff, 0xff, 0xff, 0x7f, 0xfe, 0x3f, 0xfc, 0x1f, 0xf8, 0x0f, 0xf0, 0x7f, 0xfe, 0x3f, 0xfc,
  0x1f, 0xf8, 0x0f, 0xf0, 0x47, 0xe2, 0x7f, 0xfe, 0x7f, 0xfe, 0x7f, 0xfe, 0xff, 0xff, 0xff, 0xff,
};
#ifdef HAVE_BAGL
        #include "bagl.h"
...
unsigned char const C_icon_warning_bitmap[] = {
  ...
  0xff, 0xc3, 0xf3, 0xf8, 0x7c, 0xfe, 0x1f, 0x00, 0x00,
        ...
        #endif // HAVE_BAGL
#include "glyphs.h"
unsigned int const C_old_logo_colors[] = {
  0x00000000,
  0x00ffffff,
};

unsigned char const C_old_logo_bitmap[] = {
...
#ifdef HAVE_BAGL
        #include "bagl.h"
        const bagl_icon_details_t C_old_logo = { GLYPH_old_logo_WIDTH, GLYPH_old_logo_HEIGHT, 1, C_old_logo_colors, C_old_logo_bitmap };
        #endif // HAVE_BAGL
